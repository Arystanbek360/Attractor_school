...
Route::screen('/articles/create', \App\Orchid\Screens\Article\ArticleEditScreen::class)
    ->name('platform.articles.create');

Route::screen('/articles/{article?}', \App\Orchid\Screens\Article\ArticleEditScreen::class)
