...
@section('content')
    <div style="padding-bottom: 30px;">
        <div class="d-flex">
            <h1 class="me-4 text-white">Оборудование кабинета "{{$cabinet->name}}"</h1>
            <a href="{{route('admin.items.create')}}" type="button" class="btn btn-outline-light btn-lg">
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center align-items-center">
                        <a href="{{route('admin.items.edit', ['item' => $item])}}" class="text-white">
                            Редактировать
                        </a>
                        <form method="post" action="{{route('admin.items.destroy', ['item' => $item])}}">
                            @method('delete')
                            @csrf
            ...
            <div class="collapse multi-collapse" id="multiCollapseExample1">
                <div class="card card-body bg-dark">
                    <div class="text-center scrollit d-flex flex-wrap">
                        @foreach($cabinet->comments as $comment)
                    ...
                    <div class="text-center">
                        <div class="comment-form">
                            <form id="create-comment" method="Post"
                                  action="{{route('admin.cabinets.comment.add',['cabinet'=>$cabinet])}}">
                                @csrf
                                <input type="hidden" id="cabinet_id" value="{{$cabinet->id}}">
