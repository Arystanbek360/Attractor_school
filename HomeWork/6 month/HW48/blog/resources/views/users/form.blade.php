...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="d-flex flex-column">
            <h1 class="mt-2">{{ isset($user) ?  'Редактирование пользователя' :  'Добавление пользователя'}}</h1>
            @csrf
                ...
                <div class="form-group mb-1">
                    <div class="custom-file">
                        <img
                            ...
                            src="{{asset('/storage/' . $user->picture)}}" alt="{{$user->picture}}"
                            @else
                            src="" alt=""
                            @endif
                        ...
                        <input type="file" class="form-control form-control-sm" id="customFile"
                               name="picture" value="{{isset($user, $user->picture) ? $user->picture : ''}}"
                               onchange="preview()"
                        >
