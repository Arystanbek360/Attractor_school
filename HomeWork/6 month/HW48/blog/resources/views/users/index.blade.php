                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <div class="col-8">
                                ...
                                <h6 class="card-subtitle mb-2 text-body-secondary">Фамилия:
                                    {{$user->last_name}}
                                </h6>
                                <p class="card-text">
                                    Email: {{$user->email}}</p>
                                <p class="card-text">
                                    URL-адрес: {{is_null($user->url) ? "Соц.сеть отсутсвует" : $user->url}}</p>
                            </div>
                            @if($user->picture)
                            ...
                            <div class="d-flex flex-column ml-3 align-items-center justify-content-evenly col-1">
                                <a class="navbar-brand" href="{{route('edit', ['user' => $user])}}">
